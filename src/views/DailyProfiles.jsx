            ...
            <div className="flex justify-between bg-white border rounded p-2">
                <div className="flex space-x-2">
                    ...
                    <select className="bg-[#F9F9FB] border rounded p-1 text-gray-500 text-xs" name="station" id="">
                        <option value="subtype">Station</option>
                    </select>
                    <select className="bg-[#F9F9FB] border rounded p-1 text-gray-500 text-xs" name="parameter" id="">
                        <option value="subtype">Parameter</option>
                    </select>
